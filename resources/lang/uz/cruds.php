...
return [
    ...
    'client'           => [
        ...
        'fields'         => [
            ...
            'id_passport_date'            => 'ID Passport sanasi',
            'id_passport_location'        => 'ID Passport Olingan Manzil',
            'id_passport_serial'          => 'ID Pasport seriyasi',
            'id_passport_pinfl'           => 'ID Pasport PINFL',
            'name_helper'              => ' ',
            'email'                    => 'Email',
            'email_helper'             => ' ',
