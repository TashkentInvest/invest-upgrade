                                             ...
                                             <script>
                                                $(document).ready(function() {
                                                    ...
                                                    function calculateGeneratePrice(parentAccordion) {
                                                        ...
                                                        if (!isNaN(generatePrice) && quarterlyInput > 0) {
                                                    ...
                                                    $(document).on('input change', '.branch_kubmetr, .minimum_wage, .percentage-input, .shaxarsozlik_umumiy_xajmi, .qavatlar_soni_xajmi, .avtoturargoh_xajmi, .umumiy_foydalanishdagi_xajmi, .qavat_xona_xajmi, .quarterly-input, .branch_location, .branch_type, .qurilish_turi, .zona',
                                                        function() {
                                                    ...
                                                    function calculateCoefficient() {
                                                        ...
                                                        document.getElementById('coefficient').value = coefficient.toFixed(2);
                                                        // Trigger change event for each accordion to recalculate minimum wage
                                                        $('.accordion-body').each(function() {
                                                            calculateGeneratePrice($(this));
                                                        });
                                                    }
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-6 col-xl-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" class="form-control minimum_wage"
                                                                    ...
                                                                    value="{{ $data->bazaviy_xisoblash_miqdori ?? 0 }}" readonly />
                                                            </div>
                                                        </div>
