                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-12 mb-2">
                                    ...
                                    <select class="form-control" name="mijoz_turi" id="mijoz_turi">
                                        ...
                                        <option value="yuridik" {{ $product->client->mijoz_turi == 'yuridik' ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="branch_kubmetr" name="branch_kubmetr"
