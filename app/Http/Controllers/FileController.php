...
class FileController extends Controller
{
    ...
    return view('pages.docs.mobile', compact('client', 'branch'));
    ...
    private $teens = array("ўн", "ўн бир", "ўн икки", "ўн уч", "ўн тўрт", "ўн беш",
                           "ўн олти", "ўн етти", "ўн саккиз", "ўн тўққиз");
    private $tens = array("йигирма", "ўттиз", "қирқ", "эллик", "олтмиш", "етмиш", "саксон", "тўқсон");
    private $hundreds = array("юз", "икки юз", "уч юз", "тўрт юз", "беш юз", "олти юз", "етти юз", "саккиз юз", "тўққиз юз");
